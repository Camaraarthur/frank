  ...
  governingBodies: [
    {
      ...
      party: "Labour",
      keyPolicies: [
        "Community Wealth Building strategy — local procurement and social enterprise",
        "Royal Docks regeneration and Enterprise Zone investment",
        "Newham Community Safety Partnership",
      ],
    },
    {
      level: "Local (Ward)",
      name: "Royal Docks Ward — Newham Council",
      representative: "Royal Docks ward councillors",
      party: "Labour",
      keyPolicies: [
        "Royal Docks placemaking and community engagement",
        "Housing affordability and overcrowding action plan",
      ],
    },
    {
      level: "Regional",
    ...
    {
      level: "National",
      name: "UK Parliament — East Ham",
      representative: "Stephen Timms MP",
      party: "Labour",
      keyPolicies: [
        "Social housing investment and Renters' Rights Bill",
        "Industrial strategy and local employment",
      ],
    },
  ],
  contestedIssues: [
